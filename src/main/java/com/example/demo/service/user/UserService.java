...
public class UserService {
    ...
    public ResponseDTO updateAvatar(String userId, MultipartFile multipartFile) throws IOException {
        ...
        Map result = cloudinaryService.uploadImage(multipartFile, activeProfiles[0].isEmpty() ? "prod" : activeProfiles[0] + "/avatar");
    ...
    public ResponseDTO updateCover(String userId, MultipartFile multipartFile) throws IOException {
        ...
        String[] activeProfiles = environment.getActiveProfiles();
        Map result = cloudinaryService.uploadImage(multipartFile, activeProfiles[0].isEmpty() ? "prod" : activeProfiles[0] + "/cover");
